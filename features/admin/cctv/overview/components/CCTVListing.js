      ...
      if (item.camera_status === 'Offline') {
        return (
          <SwiperSlide>
            ...
            <figure className='h-72 relative overflow-hidden rounded-lg bg-[#101524] pb-6'>
              <CCTVInactive
                width={82}
                height={80}
        ...
        <Col xs={24} sm={24} md={24} lg={12} xl={12} xxl={12}>
          <section className='p-5'>
            ...
            <div className='flex justify-between flex-wrap items-center'>
              ...
              <Typography.Text className='!text-lg'>{station.total_cameras || 0}</Typography.Text>
            </div>
            <div className='flex justify-between flex-wrap items-center'>
              <Typography.Text className='!text-lg'>ใช้งานได้</Typography.Text>
              <Typography.Text className='!text-lg'>{station.online_cameras || 0}</Typography.Text>
            </div>
            <div className='flex justify-between flex-wrap items-center'>
              <Typography.Text className='!text-lg'>ใช้งานไม่ได้</Typography.Text>
              <Typography.Text className='!text-lg'>{station.offline_cameras || 0}</Typography.Text>
            </div>
          </section>
        </Col>
      </Row>
