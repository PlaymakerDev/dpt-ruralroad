...
const FormSearchStationDetail = (props) => {
  ...
  const handlerSubmit = useCallback((values) => {
    apiGetData(`/api/v1/weight/weight_station_log`, { ...values, page: 1, page_size: initialValues.page_size }, false, {})
  }, [])
...
export default React.memo(FormSearchStationDetail)
