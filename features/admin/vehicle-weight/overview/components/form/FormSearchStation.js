...
import { DateContext } from "../tab-content/StationWeighingUnit";

const FormSearchStation = (props) => {
  const { initialValues, apiGetData, clearData, station, dateRange } = props;
  ...
  const handlerSubmit = useCallback((values) => {
    ...
    apiGetData(`/api/v1/weight/station_daily`, { ...values, page: 1, page_size: initialValues.page_size }, false, {})
